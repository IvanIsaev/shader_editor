...
VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities, const VkExtent2D& windowSize) {
...
void VulkanInstance::createSwapChain(const VkExtent2D& windowSize) {
